...
public partial class EndNodeModifier : BoardNodeModifier
{
    ...
    {
        GlobalClassesHolder.Instance.GameController.visualEffectPool.PlayVisualEffect("piece_arrived_visual_effect", GlobalPosition + new Vector3(0f, 0.51f, 0f));
        ...
        positionTween.TweenProperty(piece, "position", GlobalClassesHolder.Instance.GameController.boardController.GetPieceEndPos(piece), 0.35f).SetTrans(Tween.TransitionType.Cubic);
