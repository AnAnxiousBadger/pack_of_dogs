...
public partial class ProtectedNodeModifier : BoardNodeModifier
{
    public override void ApplyOnStepModifier(PieceController piece)
    {
        ...
        VisualEffectController effect = GlobalClassesHolder.Instance.GameController.visualEffectPool.PlayVisualEffect("protected_node_modifier_visual_effect", GlobalPosition);
