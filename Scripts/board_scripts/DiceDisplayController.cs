...
public partial class DiceDisplayController : TickableButtonController
{
	...
	private void _OnDiceRolled(int roll){
		...
		if(IsActive){
			...
			AudioManager.Instance.PlaySound(GlobalHelper.Instance.GameController.boardController.boardElementsController.boardElementsAudioLibrary.GetSound("dice_roll"));
		}
	}
